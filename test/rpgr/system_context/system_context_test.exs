defmodule Rpgr.SystemContextTest do
  ...
  describe "systems" do
    ...
    @valid_attrs %{name: "13th Age", description: "A good system"}
    @update_attrs %{name: "D&D 5.0", description: "A classic"}
    ...
    test "create_system/1 with valid data creates a system" do
      assert {:ok, %System{}} = SystemContext.create_system(@valid_attrs)
    end
