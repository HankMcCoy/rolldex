...
var combineStyles = ReactDOMRe.Style[/* combine */0];
...
function get(url, decode) {
  return fetch(url).then((function (prim) {
                ...
                return Promise.resolve(Json_decode.field("data", decode, json));
              }));
}

function post(url, payload, decode) {
  return fetch(url, Fetch.RequestInit[/* make */0](/* Some */[/* Post */2], /* Some */[{
...
function put(url, payload, decode) {
  return fetch(url, Fetch.RequestInit[/* make */0](/* Some */[/* Put */3], /* Some */[{
                          "Content-Type": "application/json"
                        }], /* Some */[JSON.stringify(payload)], /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0)(/* () */0)).then((function (prim) {
                  return prim.json();
                })).then((function (json) {
